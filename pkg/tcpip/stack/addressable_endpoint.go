...
type AddressableEndpoint interface {
	...
	//
	// Returns nil if the specified address is not local to this endpoint.
	GetAssignedEndpoint(localAddr tcpip.Address, spoofingOrPromiscuous bool, tempPEB PrimaryEndpointBehavior) AddressEndpoint
...
func (e *lockedAddressableEndpointState) GetAssignedEndpoint(localAddr tcpip.Address, spoofingOrPromiscuous bool, tempPEB PrimaryEndpointBehavior) AddressEndpoint {
	e.mu.Lock()
	defer e.mu.Unlock()
	return e.mu.ep.GetAssignedEndpoint(localAddr, spoofingOrPromiscuous, tempPEB)
}
...
// GetAssignedEndpoint implements AddressableEndpoint.
func (s *addressableEndpointState) GetAssignedEndpoint(localAddr tcpip.Address, spoofingOrPromiscuous bool, tempPEB PrimaryEndpointBehavior) AddressEndpoint {
